...
> The banners you see in the code were generated by Ai
> The rest of the code is entirely human written
> The reason for this is because its faster than manually trying to do it (I built this before I had to go to college so time was limited)
